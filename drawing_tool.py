...
class DrawingTool(cv.Canvas):
    def __init__(self, on_cell_drawn: typing.Callable[[list], None] = None,
                 on_cell_deleted: typing.Callable[[tuple], None] = None,
                 on_show_ids: typing.Callable[[tuple], None] = None):
        super().__init__()
        ...
        if self._state.drawing_mode:
            ...
            self.shapes.append(
                cv.Line(
                    ...
                    x2=x,
                    y2=y,
                    paint=ft.Paint(stroke_width=3, color=self.draw_color, style=ft.PaintingStyle.STROKE,
            ...
            self._state.lines.append((self.translate_into_image_coordinates((self._state.x, self._state.y)),
                                      self.translate_into_image_coordinates((x, y))))
            self.update()
